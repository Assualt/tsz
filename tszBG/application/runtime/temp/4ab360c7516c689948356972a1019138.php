        ...
        <header>
            <div class="header-school">
                ...
                <div class="header_login fr">
                    <li class="fl"><a href="sites/login.html">登录</a>  |</li>
            ...
            <div  class="book-list">
                <div class="book-list-left fl">
                    <div class="contact fl">
                        ...
                        <p class="fl"><a href="javascript:void(0)" id="joinus">点击加入用户体验交流群:123456789</a></p>
                    </div>
                    ...
                    <div class="fl most-focus">
                        ...
                        <ul class="most-focus-list">
                            <!--<li class="hvr-sweep-to-right">-->
                                <!--<a href="STATIC/res/user.jpg">-->
                                    <!--<img src="STATIC/res/user.jpg" alt="" width="40" height="40">-->
                                <!--</a>-->
                            <!--</li>-->
                        </ul>
                    </div>
                ...
                <div class="book-list-right fl">
                        ...
                        <div class="book-recommend-body fl">
                            <!--<div class="book-info fl">-->
                                <!--<a href="javascript:void(0)">-->
                                    <!--<img src="STATIC/卡耐基.jpg.jpg" alt="卡耐基口才" width="100" height="130">-->
                                <!--</a>-->
                                <!--<div>-->
                                    <!--<h6>卡耐基魅力口才</h6>-->
                    ...
                    <div class="fl book-discount">
                        <div class="fl book-discount-head">
                            <p class="fl">特惠图书<i class="fa fa-book" style="color: lightseagreen;"></i></p>
                            <a href="javascript:void(0)" class="fr">更多<i class="fa fa-angle-right"></i></a>
                        </div>
                        <div class="fl book-discount-body">
                            <ul class="fl book-discount-body-list">
                                <li class="book-info1">
                                    <a href="STATIC/res/book_img/5分钟丰胸.jpg" >
                                        <img src="STATIC/res/book_img/5分钟丰胸.jpg" alt="s" width="90" height="120" class="hvr-grow">
                                    </a>
                                    <div>
                                        <h6>5分钟丰胸</h6>
                                        <p class="fl now—price">
